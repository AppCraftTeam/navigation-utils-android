...
open class AppNavigator(
     ...
     */
    private fun unexistingActivity(screen: AppScreen, activityIntent: Intent) {
     ...
     */
    private fun createFragment(screen: AppScreen): Fragment? {
    ...
    private fun errorWhileCreatingScreen(screen: AppScreen) {
